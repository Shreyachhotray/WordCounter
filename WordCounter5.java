...
public class WordCounter5 {

    public static void main(String[] args) {
        System.out.println("Welcome to Word Counter!");

        // Ask the user to choose between entering text or providing a file
    ...
    private static int countWords(String text) {
        ...
        int wordCount = 0; // Initialize the counter variable to keep track of the number of words
        for (String word : words) {
            if (!word.isEmpty()) {
                wordCount++; // Increment the counter for each non-empty word encountered
            }
        }
        return wordCount;
    }
